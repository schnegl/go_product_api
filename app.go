...
// getProduct Gets a certain single prodcut. Uses id specified in the path.
...
// getProducts uses count an start form params to fetch count number of products started at position start (thus is pagination ready)
...
// createProduct Creates a product passed as a JSON Body
...
// updateProduct Updates a given product selected via id
...
// respondWithJSON Sends given payload back as an http response encapsulated in an json object
